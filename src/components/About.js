...
export default function About() {
    ...
    const [darkText, setDarkText] = useState('Disable')

    let toggleStyle = () => {
        if (newStyle.color === '#fafafa') {
            setNewStyle({
                color: '#666666',
    ...
    return (
        <>
            <div className="container">
                ...
                <button onClick={toggleStyle} type="button" className="my-4 btn btn-secondary">{darkText} Dark Mode</button>
            </div>
        </>
    )
}
